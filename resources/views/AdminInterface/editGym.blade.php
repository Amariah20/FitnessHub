...
<div class="card" style="width: 18rem; margin-top:-800px;">
        ...
        <div class="card" style="width: 18rem; margin-top:-750px;padding-bottom:10px;">
            <div class="icon">
                <svg  xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"  class="bi bi-info-circle" viewBox="0 0 16 16">
                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
        ...
        <div class="card" style="width: 35rem; margin-top:600px;padding-top:20px;">
            <div class="icon">
                <svg  xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"  class="bi bi-info-circle" viewBox="0 0 16 16">
                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">In order to display your business on the map, please enter your latitude and longitude. This step is optional. 
                            <p class="card-text"> To get the coordinates for your business: </p>
                                   ...
                                   <li> <p> Open <a href= "https://www.google.com/maps" target="_blank" style="color:blue; text-decoration:underline;">Google Maps</a>.  </p>

                                   <li> <p> Right-click the place or area on the map. </p>

                                  <li>  <p> This will open a pop-up window. You can find your latitude and longitude in decimal format at the top. </p>

                                  <li> <p> To copy the coordinates automatically, left click on the latitude and longitude.</p> </p>
