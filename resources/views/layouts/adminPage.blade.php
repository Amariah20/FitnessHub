...
<div class="sideNav">
    ...
    <ul>
        <li>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-info-circle" color="black" viewBox="0 0 16 16">
        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
        <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
        </svg><a href="{{ route('AdminBusiness',['Gym_id' => $Gym_id])}} "> Business Information</a><!--not working. need another page with business info to put here-->
        
    
        <li>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" color="black" fill="currentColor" class="bi bi-person-walking" viewBox="0 0 16 16">
        ...
        <li>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" color="black" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">
        ...
        <li>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" color="black" class="bi bi-person-check" viewBox="0 0 16 16">
        ...
        <li>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" color="black" fill="currentColor" class="bi bi-bicycle" viewBox="0 0 16 16">
        ...
        <li>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" color="black" class="bi bi-envelope-arrow-up" viewBox="0 0 16 16">
        ...
        <li>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" color="black" fill="currentColor" class="bi bi-browser-edge" viewBox="0 0 16 16">
        ...
        <li>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" color="black" class="bi bi-plus-circle" viewBox="0 0 16 16">
        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
        ...
        @if($user->gym->count()>1)
        <li>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" color="black" fill="currentColor" class="bi bi-laptop-fill" viewBox="0 0 16 16">
        ...
        </svg><a href="{{ route('AdminFirst') }}"> Manage Other Gyms</a>      
        </li>
        @endif
        <li>
